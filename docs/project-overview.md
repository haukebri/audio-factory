...
- **Planned owner-authorized migration (2026-09-09):** [M2 task 08](tasks/m02/08-medium-gguf-generation.md) replaces generation with Stable Audio 3 Medium GGUF F16, including `stable-audio-3-medium-same-l-v1.0-F16.gguf` and its required companion artifacts/runtime. This supersedes the extraction-era MLX/C++ restriction for that task; it is not yet implemented.
