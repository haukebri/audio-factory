...
Implement repeatable comparison of signal/CLAP baseline, audio judge and bounded selection policy. Report confusion counts, precision, false accepts/rejects, uncertainty coverage, human approval of selected outcomes, attempts and latency with denominators and uncertainty. Freeze thresholds/rubrics/policies and benchmark manifests; support selecting a tested policy and rollback without rewriting old verdicts. Begin with evaluation-driven rubric/region-policy adjustments, not online model training.
