...
try {
  const files = ["run", "src", "package.json", "pnpm-lock.yaml", "tsconfig.json",
    ...
    "qa.py", "evaluation.mjs", "judge.mjs", "prompt-plan.mjs", "judge-policy.json", "docs/tasks/m02/clap-m1-baseline.lock.json", "bundle.mjs", "export-lineage.mjs", "retain.mjs", "workflow.mjs", "studio.mjs", "studio.html", "studio.css", "studio.js", "review-store.mjs",
